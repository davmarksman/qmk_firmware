...
//  TODO: replace a tab with Del
 [_BASE] = LAYOUT(
    ...
    KC_DEL,   KC_X,   KC_B,    KC_M,    KC_D,    KC_V,    K_CLIP,  K_AHK,     TD(TD_SCLN),KC_P,    KC_COMM, KC_DOT,  KC_SLSH, KC_NUBS,
                      KC_LEFT, KC_RGHT, KT_A_TAB,K_OSFT,  LSYN_BK, L1_SPC,    KC_N,       KC_ENT,  KC_RALT, KC_RGUI
),
...
[_L1] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, K_UNDOTB,                    XXXXXXX, K_AND,   K_GRV3,  K_OR,    XXXXXXX, KC_F12,
    XXXXXXX, K_EQ_GR, KC_EXLM, KC_LPRN, KC_RPRN, K_GLOBAL,                    XXXXXXX, KC_AT,   KC_UNDS, K_PIPE,  XXXXXXX, XXXXXXX,
    KC_CAPS, KS_X2X,  XXXXXXX, KC_LBRC, KC_RBRC, XXXXXXX,   LBASE,  LGAME,    K_SNIP,  K_SNIP,  XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,
...
[_SYNAV] = LAYOUT(
    ...
    XXXXXXX,KC_LALT,RCS(KC_NO),KC_LCTL, KC_LSFT, KC_LGUI,                     KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX,
    KC_DEL,  K_UNDO,  C(KC_X), C(KC_C), C(KC_V), XXXXXXX,  LBASE, LGAME,      XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),

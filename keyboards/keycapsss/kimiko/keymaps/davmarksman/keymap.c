...
//  TODO: replace a tab with Del
 [_BASE] = LAYOUT(
    ...
    KC_DEL,   KC_X,   KC_B,    KC_M,    KC_D,    KC_V,    K_CLIP,  K_AHK,     TD(TD_SCLN),KC_P,    KC_COMM, KC_DOT,  KC_SLSH, KC_GRV,
                      KC_LEFT, KC_RGHT, LSYN_TAB,K_OSFT,  KT_C_BK, L1_SPC,    LSYN_N,     KC_ENT,  KC_LALT, KC_RGUI
),
...
[_L1] = LAYOUT(
    ...
    _______, XXXXXXX, A(KC_LEFT),A(KC_RGHT),XXXXXX,K_UNDOTB,                  XXXXXXX, K_AND,   K_GRV3,  K_OR,    XXXXXXX, KC_F12,
    XXXXXXX, XXXXXXX, KC_LBRC, KC_LCBR, KC_LPRN, K_GLOBAL,                    XXXXXXX, KC_AT,   KC_UNDS, K_PIPE,  XXXXXXX, XXXXXXX,
